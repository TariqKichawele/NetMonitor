        ...
        <div className='flex flex-col gap-y-6 gap-x-[24px] lg:flex-row'>
            <div className='w-full rounded-[8px] bg-[#F5F4FF] p-6 flex flex-col lg:justify-between'>
                <div>
                    ...
                    <p className='pt-[12px] text-[#36485C] lg:text-[18px]'>
                        A basic, no-cost plan for new users to test the service with limited features
                    </p>
                    ...
                    <ul className='flex flex-col gap-y-2 pt-4 text-[#5F7896]'>
                        <li className='flex items-center gap-x-2 pt-5'>
                            <span>
            ...
            <div className="w-full rounded-[8px] bg-[#4328EB] p-6 flex flex-col">
                <div>
                    ...
                    <p className="pt-[12px] text-[#F4F8FA] lg:text-[18px]">
                        A mid-tier plan designed for small businesses with more advanced features and support
                    </p>
            ...
            <div className="w-full rounded-[8px] bg-[#F5F4FF] p-6 flex flex-col lg:justify-between">
                <div>
                    ...
                    <p className="pt-[12px] text-[#36485C] lg:text-[18px]">
                        A customizable plan for large companies requiring extensive monitoring capabilities and premium support
                    </p>
                   ...
                   <ul className='flex flex-col gap-y-2 pt-4 text-[#5F7896]'>
                        ...
                        <li className="flex items-center gap-x-2">
                            ...
                            Multi-channel alerts (Email, SMS, Slack, etc.)
                        </li>
                        <li className="flex items-center gap-x-2">
                            <span>
                                    <Image src={Check} alt="included" />
